...
namespace Catfood.Shapefile
{
    ...
    static class ShapeFactory
    {
        ...
        public static Shape ParseShape(byte[] shapeData)
        {
            if (shapeData == null)
            {
            ...
            switch (shapeType)
            {
                ...
                case ShapeType.Point:
                    shape = new ShapePoint(shapeData);
                    break;

                case ShapeType.MultiPoint:
                    shape = new ShapeMultiPoint(shapeData);
                    break;

                case ShapeType.PolyLine:
                    shape = new ShapePolyLine(shapeData);
                    break;

                case ShapeType.PolyLineM:
                    shape = new ShapePolyLineM(shapeData);
                    break;

                case ShapeType.Polygon:
                    shape = new ShapePolygon(shapeData);
                    break;
