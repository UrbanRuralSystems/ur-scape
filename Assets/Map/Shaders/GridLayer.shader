	...
	SubShader
	{
		...
		Pass
		{
			CGPROGRAM
				...
				#pragma multi_compile GRADIENT CATEGORIZED STRIPES_UNIFORM STRIPES_UNIFORM_REVERSE STRIPES_1 STRIPES_2 STRIPES_3 STRIPES_4 STRIPES_5
